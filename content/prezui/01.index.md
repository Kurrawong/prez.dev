...
![Screenshot of a catalogue in Prez UI](/img/catalog_example.png)
...
> [!IMPORTANT]  
> If you're upgrading your Prez UI theme from < v4.2.0 to v4.2.0+, you will need to [follow the upgrade guide](/prezui/upgrade) to upgrade to Nuxt v4 & Tailwind v4, which is a breaking change.
...
- [`create-prez-app`](https://www.npmjs.com/package/create-prez-app): the NPX starter template for initialising a Prez UI theme
...
## License
This version of Prez UI and the contents of this repository are also available under the [BSD-3-Clause License](https://opensource.org/license/BSD-3-Clause).