...
[Docker Compose](https://docs.docker.com/compose/) can be used to run a demonstration instance. The compose files comprises three services: Prez (PrezAPI), PrezUI, and Fuseki. To run the stack, change directory into the `demo` directory and run: `docker compose up`.
