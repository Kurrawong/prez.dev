...
<template>
	<div class="grow translate-[0%] overflow-hidden max-w-[1400px] mx-auto w-full flex">
		<SidebarProvider class="min-h-full grow">
			<AppSidebar :collection="props.collection" />
			<div class="grid grid-cols-[1fr_max-content] grid-rows-[min-content_1fr] lg:grid-rows-1 grow p-3 gap-3">
